// ================================================================
//  editor.js — Vista editor: importa storia JSON (invariato)
// ================================================================
...
function closeEditor() { showView('home'); renderHome(); }
...
function switchTab(tab) {
  ...
  document.getElementById('drop-zone').classList.toggle('shown', tab === 'file');
  document.getElementById('error-msg').classList.remove('visible');
}
...
// Drag-and-drop wiring (called from app.js after DOM ready)
function initEditorDrop() {
