const translations = {
  it: {
    ...
    editor: {
      ...
      errorMissingLang: 'Campo "lingua" mancante. Usa "it" o "en".',
      errorDuplicate: 'Esiste già una storia chiamata "',
      errorDuplicateQuestion: '". Sostituirla?',
      errorWrongLang: 'Questa storia è in una lingua diversa dalla tua.',
    ...
    fab: {
      tooltip: 'Crea o importa storia'
    },
    footer: {
      text: 'Sceglitu &mdash;',
      license: '&mdash; Licenza GPL&nbsp;3.0 &copy; Qc-17'
    },
    toast: {
  ...
  en: {
    ...
    editor: {
      ...
      errorMissingLang: 'Field "lingua" missing. Use "it" or "en".',
      errorDuplicate: 'A story named "',
      errorDuplicateQuestion: '" already exists. Replace it?',
      errorWrongLang: 'This story is in a different language than yours.',
      saveBtn: '💾 Save story',
    ...
    fab: {
      tooltip: 'Create or import story'
    },
    footer: {
      text: 'Sceglitu &mdash;',
      license: '&mdash; GPL License 3.0 &copy; Qc-17'
    },
    toast: {
