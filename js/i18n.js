...
const translations = {
  it: {
    ...
    editor: {
      ...
      guideP3: 'È disponibile un editor visuale completo:<br><a class="editor-cta-btn" href="editor.html">✏️ Apri l\'editor visuale</a>',
  ...
  en: {
    ...
    editor: {
      ...
      guideP3: 'A complete visual editor is available:<br><a class="editor-cta-btn" href="editor.html">✏️ Open visual editor</a>',
